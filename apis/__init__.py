...
from .seeking_alpha.symbol_financial_info import *
...
info_fields_short =  ['Date', 'symbol', 'peRatioFwd', 'estimateEps', 'divYield', 'shortIntPctFloat', 'marketCap','volume']
info_fields_long = ['Date','divYield','eps','estimateEps','evEbit','evEbitda','evFcf','evSales','fcf','fcfShare',
                    'ltDebtCap','marketCap','movAvg10d','movAvg10w','movAvg200d','payout4y','payoutRatio','pegRatio','peRatioFwd','priceBook','priceCf','priceSales','priceTangb','quickRatio','revenueGrowth','revenueGrowth3','roa','roe','shares','shortIntPctFloat','symbol','volume']
