...
dct_sum_col_names = {md.portfolio_adjustments:['Buy/Sell $','Current Value', 'Current Value %', 'Holding %', 'Cost Basis Total'],md.portfolio_proforma:['Current Value','Cost Basis Total','Current Value %']}
dct_currency_col_names = {md.portfolio_adjustments:['Buy/Sell $', 'Current Value', 'Cost Basis Total'],md.portfolio_proforma:['Current Value','Cost Basis Total']}
dct_percent_col_names = {md.portfolio_adjustments:['Current Return %', 'Current Value %', 'Holding %','Buy/Sell %'],md.portfolio_proforma:['Current Value %','Current Value %']}
